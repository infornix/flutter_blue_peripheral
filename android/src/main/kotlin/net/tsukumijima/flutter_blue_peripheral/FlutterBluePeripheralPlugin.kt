...
/** FlutterBluePeripheralPlugin */
class FlutterBluePeripheralPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    private var TAG = "FlutterBluePeripheralPlugin";
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "flutter_blue_peripheral")
    ...
    // save activity
    // ref: https://qiita.com/ko-izumi/items/216f2fb7dc51d85884e4
    override fun onAttachedToActivity(binding: ActivityPluginBinding) {
        FlutterBluePeripheralPlugin.activity = binding.activity
    }
    ...
    open fun startPeripheral() {
        ...
        if (FlutterBluePeripheralPlugin.registerReceiver == false) {
            FlutterBluePeripheralPlugin.registerReceiver = true
                ...
                override fun onReceive(context: Context?, intent: Intent?) {
                    ...
                    if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
                        ...
                        if (statestr == "poweredOn") {
                            this@FlutterBluePeripheralPlugin.startPeripheral()
                        }
                    }
                }
            }
            val filter = IntentFilter(BluetoothAdapter.ACTION_STATE_CHANGED)
            FlutterBluePeripheralPlugin.activity?.registerReceiver(mR, filter)
        }
        ...
        if (mBluetoothAdapter!!.isMultipleAdvertisementSupported()) {
            ...
            Toast.makeText(FlutterBluePeripheralPlugin.activity?.applicationContext, "MultipleAdvertisement not Supported", Toast.LENGTH_SHORT).show()
        }
    }

    private fun ensureBleFeaturesAvailable() {
        if (mBluetoothAdapter == null) {
            Toast.makeText(FlutterBluePeripheralPlugin.activity?.applicationContext, "Not support host.", Toast.LENGTH_SHORT).show()
