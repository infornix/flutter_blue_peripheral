...
public class SwiftFlutterBluePeripheralPlugin: NSObject, FlutterPlugin, CBPeripheralManagerDelegate {

    var TAG = "[FlutterBluePeripheralPlugin] "
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name:"flutter_blue_peripheral", binaryMessenger: registrar.messenger())
        let instance = SwiftFlutterBluePeripheralPlugin()
